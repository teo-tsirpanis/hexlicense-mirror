...
begin
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JScanResult', TypeInfo(JScanResult));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiConfiguration', TypeInfo(JWifiConfiguration));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiConfigurationAuthAlgorithm', TypeInfo(JWifiConfigurationAuthAlgorithm));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiConfigurationGroupCipher', TypeInfo(JWifiConfigurationGroupCipher));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiConfigurationKeyMgmt', TypeInfo(JWifiConfigurationKeyMgmt));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiConfigurationPairwiseCipher', TypeInfo(JWifiConfigurationPairwiseCipher));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiConfigurationProtocol', TypeInfo(JWifiConfigurationProtocol));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiConfigurationStatus', TypeInfo(JWifiConfigurationStatus));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiInfo', TypeInfo(JWifiInfo));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiManager', TypeInfo(JWifiManager));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiManagerMulticastLock', TypeInfo(JWifiManagerMulticastLock));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JWifiManagerWifiLock', TypeInfo(JWifiManagerWifiLock));
  TRegTypes.RegisterType('Androidapi.JNI.Net.Wifi.JSupplicantState', TypeInfo(JSupplicantState));
end;
